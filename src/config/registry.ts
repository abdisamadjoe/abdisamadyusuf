export const registryConfig = {
   ...
   * @example "@abdisamadjoe" - Users can install components with: `npx shadcn add @abdisamadjoe/text-flip`
   * @see https://ui.shadcn.com/docs/registry/namespace#overview
   */
  namespace: process.env.NEXT_PUBLIC_REGISTRY_NAMESPACE || "@abdisamadjoe",
  /**
   * URL pattern for resolving namespaced components
   * The {name} placeholder will be replaced with the component name
   * @example "https://abdisamadjoe.com/r/{name}.json" resolves to "https://abdisamadjoe.com/r/text-flip.json"
  ...
  namespaceUrl:
    ...
    "https://abdisamadjoe.com/r/{name}.json",
}
