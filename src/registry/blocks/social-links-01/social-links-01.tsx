...
const SOCIAL_LINKS: SocialLink[] = [
  {
    icon: "https://assets.abdisamadjoe.com/images/link-icons/x.webp",
    title: "X",
    href: "https://x.com/abdisamadjoe",
  },
  {
    icon: "https://assets.abdisamadjoe.com/images/link-icons/github.webp",
    title: "GitHub",
    href: "https://github.com/abdisamadjoe",
  },
  {
    icon: "https://assets.abdisamadjoe.com/images/link-icons/linkedin.webp",
    title: "LinkedIn",
    href: "https://linkedin.com/in/abdisamadjoe",
  },
  {
    icon: "https://assets.abdisamadjoe.com/images/link-icons/dailydotdev.webp",
    title: "daily.dev",
    href: "https://app.daily.dev/abdisamadjoe",
  },
  {
    icon: "https://assets.abdisamadjoe.com/images/link-icons/discord.webp",
    title: "Discord",
    href: "https://discord.com/users/1186630645443739651",
  },
  {
    icon: "https://assets.abdisamadjoe.com/images/link-icons/youtube.webp",
    title: "YouTube",
    href: "https://www.youtube.com/@abdisamadjoe",
  },
]
