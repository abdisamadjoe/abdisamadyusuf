...
export function CertificationItem({
  ...
  return (
    <div
      className={cn(
        "group/certification relative flex items-center pr-2 hover:bg-accent-muted",
        className
      )}
    >
      {certification.issuerLogoURL ? (
        <Image
          ...
          height={32}
          quality={100}
          className="mx-4 flex size-6 shrink-0 grayscale transition-[filter] duration-300 ease-out select-none group-hover/certification:grayscale-0"
          unoptimized
          aria-hidden
        />
      ) : (
