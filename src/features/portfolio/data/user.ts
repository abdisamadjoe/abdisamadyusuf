...
// Replaced in <Hello /> with the live playlist view count from
// `/api/youtube-views` (falls back to `YOUTUBE_VIEWS_FALLBACK` while
// loading or if the request fails). See src/hooks/use-youtube-views.ts.
export const YOUTUBE_VIEWS_PLACEHOLDER = "{{YOUTUBE_VIEWS}}"
export const YOUTUBE_VIEWS_FALLBACK = "14,000+"
...
- When I'm Not Building, I create Cybersecurity and Linux courses and tutorials. My Somali Linux course, <img src="https://img.logo.dev/udemy.com?token=${process.env.NEXT_PUBLIC_LOGO_DEV_TOKEN || "pk_AA1JIHN2QAisZYnOhY9-Cw"}" alt="udemy.com logo" style="height: 1.2em; width: auto; display: inline-block; vertical-align: middle; margin-left: 0.5em; margin-right: 0.2em;" /> [Barashada Linux: Bilaw ilaa Dhamaad](https://www.udemy.com/course/linux-fundamentals-somali/), has been taken by 200+ students on Udemy and has reached ${YOUTUBE_VIEWS_PLACEHOLDER} views on <img src="/icons/youtube.svg" alt="youtube logo" style="height: 1.2em; width: auto; display: inline-block; vertical-align: middle; margin-left: 0.5em; margin-right: 0.2em;" /> [YouTube](https://www.youtube.com/playlist?list=PL6zJ5N-7oCScU0wMS0cqM_sAoruf2RRLw).
